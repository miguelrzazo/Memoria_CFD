...
%========================================
% HARDWARE Y SOFTWARE (integrado en la Introducción)
%========================================
% El contenido de hardware y software se ha integrado en la sección de introducción.
%\input{sections/08_hardware_software}
...
%========================================
\appendix
% El anexo de código se comenta temporalmente; el código completo está en el repositorio.
%\input{sections/09_anexos_codigo}
