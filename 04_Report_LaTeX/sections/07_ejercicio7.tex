...
La amplitud de las oscilaciones es aproximadamente $C_L \approx \pm 0.35$, reflejando la alternancia del desprendimiento de vórtices entre los lados superior e inferior del cilindro. La Fig.~\ref{fig:Cd_Cl_detalle_ej7} muestra un detalle de las oscilaciones durante los últimos 10 segundos de simulación.
