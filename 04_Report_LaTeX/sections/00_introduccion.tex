...
\begin{enumerate}
    \item \textbf{Capítulo 1 -- Método de Hess-Smith:} Implementación del método de paneles para el cálculo de distribuciones de presión y coeficientes aerodinámicos sobre perfiles bidimensionales

    \item \textbf{Capítulo 2 -- Método de Multhopp (Lifting Line):} Aplicación de la teoría de línea sustentadora a alas rectas, incluyendo efectos de alerones.
    ...
    \item \textbf{Capítulo 6 -- Verificación Numérica:} Estudio de convergencia de malla para flujo laminar alrededor de cilindro a $Re = 1$. Aplicación del Grid Convergence Index (GCI) para cuantificar la incertidumbre numérica debida a discretización espacial y validación contra solución analítica de Lamb.
...
\begin{itemize}
    \item \textbf{\textit{MATLAB} R2025b:} Para la implementación de métodos potenciales (Hess-Smith, Multhopp, VLM) y post-procesamiento de resultados OpenFOAM. Se aprovechan las capacidades de álgebra lineal y visualización de MATLAB para análisis numéricos.

    \item \textbf{\textit{OpenFOAM} 13:} Software de código abierto para CFD basado en el método de volúmenes finitos.
...
\begin{itemize}
    ...
    \item \textbf{Sistema operativo:} macOS 26.1 (build 25B78)
...
\textbf{Repositorio:}
\begin{center}
\url{https://github.com/miguelrzazo/Memoria_CFD}
\end{center}
