...
La Fig.~\ref{fig:resumen_convergencia_ej6} presenta un resumen de todos los parámetros del estudio de convergencia.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{Ejercicio6/resumen_convergencia.png}
    \caption{Resumen del estudio de convergencia de malla: orden de convergencia, valor extrapolado de Richardson y métricas GCI.}
    \label{fig:resumen_convergencia_ej6}
\end{figure}
...
Para evaluar si la configuración espacial de la malla introduce sesgos direccionales, se realizaron simulaciones adicionales con la malla fina rotando el ángulo de incidencia del flujo: $\alpha = -5°$, $0°$ y $+5°$.
...
La Fig.~\ref{fig:velocidad_fine_ej6} visualiza la magnitud del campo de velocidad $|\mathbf{U}|$ en el dominio computacional para la malla fina. La representación mediante colores (colormapa Rainbow Uniform) permite identificar las regiones de alta y baja velocidad.
...
\begin{figure}[htbp]
    ...
    \caption{Campo de presión en la malla fina para $Re = 1$. La colormapa Cool to Warm resalta las zonas de alta presión (rojo, aguas arriba) y baja presión (azul, costados). La distribución simétrica confirma el carácter reversible del flujo de Stokes en régimen laminar.}
