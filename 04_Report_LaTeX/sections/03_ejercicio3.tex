...
La Fig.~\ref{fig:Cp_VLM} muestra la distribución del coeficiente de presión a lo largo de la envergadura.

\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{Ejercicio3/Cp_distribucion.png}
    \caption{Distribución del coeficiente de presión $C_p$ a lo largo de la envergadura para diferentes ángulos de ataque.}
    \label{fig:Cp_VLM}
\end{figure}

El coeficiente de presión muestra valores más negativos (mayor succión) a ángulos de ataque elevados, consistente con el aumento de sustentación. La distribución spanwise refleja los efectos de la geometría del ala (flecha y estrechamiento).
